...
export const PLANS: Record<PlanSlug, Plan> = {
  ...
  "redup-full": {
    ...
    tagline:
      "O método completo mais a plataforma que executa. Você aprende a lógica e já opera a Redrive por um ano inteiro — do conceito à prática, sem intervalo.",
    includesImplementation: false,
    requiresShippingAddress: true,
    requiresOnboardingScheduling: false,
    guaranteeDays: 7,
    features: [
      ...
      "12 meses de Redrive Enterprise — plataforma completa",
...
export const COMPARISON_ROWS: { label: string; redup: boolean; redmax: boolean }[] = [
  { label: "12 meses de Redrive Enterprise (plataforma completa)", redup: true, redmax: true },
